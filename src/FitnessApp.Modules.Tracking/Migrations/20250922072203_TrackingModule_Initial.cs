        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_from_program = table.Column<bool>(type: "bit", nullable: false),
                    program_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    workout_session_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<double>(type: "float(10)", precision: 10, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    total_duration_seconds = table.Column<int>(type: "int", nullable: true),
                    calories_estimated = table.Column<int>(type: "int", nullable: true),
                    perceived_difficulty = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    workout_session_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Value = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    Repetitions = table.Column<int>(type: "int", nullable: true),
                    weight_kg = table.Column<double>(type: "float(6)", precision: 6, scale: 2, nullable: true),
                    duration_seconds = table.Column<int>(type: "int", nullable: true),
                    distance_meters = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: true),
                    Sets = table.Column<int>(type: "int", nullable: true),
                    performance_score = table.Column<double>(type: "float(5)", precision: 5, scale: 2, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
